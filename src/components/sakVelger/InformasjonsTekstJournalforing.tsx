import { BodyLong, BodyShort, InlineMessage, ReadMore, VStack } from '@navikt/ds-react';
    ...
    return (
        <VStack paddingBlock="space-0 space-8" gap="space-16">
            <ReadMore header="Hva skjer når en dialog journalføres?">
                ...
                Ved journalføring blir det umiddelbart opprettet et dokument tilknyttet saken. Dokumentet inneholder de
                meldingene som finnes i samtalen på det tidspunktet dialogen journalføres. Det blir ikke sendt til
                bruker, men du kan finne dokumentet igjen i dokumentoversikten i Modia personoversikt eller i Gosys. Så
                lenge dialogen ikke er avsluttet, kan du starte ny journalføring for både eksisterende og nye saker. Et
                nytt dokument opprettes umiddelbart. Når dialogen avsluttes vil det skje en automatisk journalføring av
                dialogen. Dette skjer på natten etter at dialogen er avsluttet, og dokumentet blir synlig både internt
                og for bruker dagen etter.
                ...
                <BodyLong spacing>
                    ...
                    dokument med den første meldingen blir opprettet. Deretter gjelder informasjonen over. Ved referat
                    må du huske å manuelt legge til sak for at det skal journalføres.
                </BodyLong>
            </ReadMore>
