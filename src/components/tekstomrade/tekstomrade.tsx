...
import { BoldRule, HighlightRule, LinebreakRule, LinkRule, ParagraphRule } from './parser/rules';
...
export const defaultRules = [HighlightRule, BoldRule, LinkRule, LinebreakRule, ParagraphRule];
