...
import { capitalizeFirstLetter, formaterDato } from 'src/utils/string-utils';
        ...
        <>
            {dodsbo.map((dodsbo, index) => {
                return (
                    ...
                    >
                        <BodyShort size="small">Skifteform: {capitalizeFirstLetter(dodsbo.skifteform)}</BodyShort>
