...
import { FOR_MANGE_TREFF_TEKST, PersonsokResult } from './PersonsokResult';
...
describe('PersonsokResult', () => {
    ...
    test('henter neste side først når brukeren blar', async () => {
        ...
        expect(await screen.findByText('Viser 101–132 av 132 treff')).toBeInTheDocument();
    ...
    test('henter ikke på nytt når brukeren blar tilbake til en side som er hentet', async () => {
        ...
        await screen.findByText('Viser 51–100 av 132 treff');
    ...
    test('viser egen melding når søket gir for mange treff (400)', async () => {
        lyttPaaV4(() => HttpResponse.json({ message: 'Søket gav mer enn 200 treff' }, { status: 400 }));
