import { Button, List, VStack, Box } from '@navikt/ds-react';
...
function StandardtekstListe({ listeRef }: { listeRef: React.RefObject<HTMLDivElement | null> }) {
    ...
    return (
        <VStack overflow="auto" height="60vh">
            ...
            <div id="standardtekster-liste" ref={listeRef}><Box marginBlock="space-16" asChild><List data-aksel-migrated-v8>
                        {tekstElementer}
                    </List></Box></div>
