const standardTeksterMock = {
    ...
    '1c923d77-4137-4fc0-a541-d1f5ce378da8': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] etterspør sjukepengar for perioden FRÅDATO-TILDATO. Eg har informert om at NAV manglar DOKUMENTASJON som er naudsynt for at sjukepengane skal bli utbetalt. Eg har bedt om at DOKUMENTASJON leverast snarast mogleg.'
        }
    },
    ...
    '82fad1d1-4635-47d0-8c46-168671a5f151': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] spør kor langt søknaden om (YTING) har kome. Søknaden er motteke (DATO) og det er (TAL) veker sakshandsamingstid. [bruker.fornavn] har fått informasjon om å følgje med på Ditt NAV for status framover.'
        }
    },
    ...
    '1f1e45c8-fe08-45ed-8a39-50ee3d76c2d4': {
        ...
        innhold: {
            ...
            nn_NO:
                'Takk for di tilbakemelding. Vi ber om orsaking for at vi i dag ikkje oppfyller lova sitt krav til målform. Vi jobbar med å forbetre oss på dette området.'
        }
    },
    ...
    'd3491aff-d668-499e-9742-9dcc37c715e1': {
        ...
        innhold: {
            ...
            nn_NO:
                '- at du kan nytta aktivitetsplan til å registrera jobbar du har søkt på, arbeidsgivarar som er kontakta og tilbakemeldingar frå arbeidsgivarar. Sjå her: https://www.nav.no/no/Person/Arbeid/Arbeidsledig+og+jobbsoker/Jobbsokertips/Bruk+aktivitetsplanen+din\r\n',
            en_US:
                '- that you can use the activity plan to register jobs you have applied for, employers you have contacted and responses you have received from employers. You can find job log information here (text in Norwegian): https://www.nav.no/no/Person/Arbeid/Arbeidsledig+og+jobbsoker/Jobbsokertips/Bruk+aktivitetsplanen+din'
        }
    },
    ...
    '1100c9af-b723-4ed6-a730-bcc8974379dc': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] er innkalla til avtale med sin rettleiar den DATO OG KLOKKESLETT, men kan ikkje møte på grunn av ORSAK og ber om nytt møtetidspunkt.\r\n\r\nDu har fått informasjon om at du vert kontakta innan utgongen av DAG+DATO',
            en_US:
                '[bruker.navn] has been summoned to a meeting with (his/her) contact person the DATE AND TIME, but is not able to come because REASON, and has requested a new appointment.\r\n\r\nYou have been informed that you will be contacted within the end of the DAY+DATE'
        }
    },
    ...
    '0325b2ae-67ee-41eb-992c-3ff4cce3dfaf': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] kontaktar NAV og ønskjer å gje munnleg samtykke om utlevering av opplysningar i eiga sak. Samtykket gjeld berre for aktuell samtale og dei forholda det er samtykka til.\r\n\r\n[bruker.navn] er identifisert på følgjande måte:\r\n- (FREMGANGSMÅTE FOR SIKKER IDENTIFISERING)\r\n\r\nDet er gjeve munnleg samtykke til (FULLT NAMN).\r\nDet vart ringt frå (TELEFONNUMMER) då samtykket vart gjeve.\r\n\r\nSamtykket gjeld følgjande opplysningar:\r\n- (OPPLYSNINGAR)\r\n\r\nDu har fått informasjon om:\r\n- Samtykket gjeld berre for denne henvendinga.\r\n- Viss du ønskjer å oppnemne ein fullmektig må du sende oss skjema NAV 95-15.36 eller melding via Ditt NAV. Ei slik melding må innehalde: namn på fullmektig, for kva periode og for kva informasjon fullmakta gjeld.\r\n',
            en_US:
                '[bruker.navn] has contacted NAV to give verbal consent on the disclosure of information in his own case. This consent is only valid for this specific conversation.\r\n\r\n[bruker.navn] has been identified by:\r\n- (FREMGANGSMÅTE FOR SIKKER IDENTIFISERING)\r\n\r\nOral consent has been given to: (FULLT NAVN).\r\n\r\nThe telephone call was made from the following telephone number:\r\n\r\nThe consent applies to the following information:\r\n- (OPPLYSNINGER DET ER GITT SAMTYKKE TIL Å UTLEVERE)\r\n\r\nYou have been informed that:\r\n- This consent is only valid for this specific conversation\r\n- If you would like the power of attorney to apply for future inquiries, please send us form NAV 95-15.36 or send a power of attorney electronically through “Ditt NAV/Innboks”\r\n\r\nIf you choose to send the power of attorney electronically, it must contain the following information:\r\n- Name of the authorised person\r\n- Which period the power of attorney is valid (from and to date)\r\n- Which information authorised person is permitted to receive'
        }
    },
    ...
    '89c8927a-030e-4942-9ba7-bb96473d4c4a': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] ønskjer kontakt med rettleiaren sin. Samtalen gjeld SETT-INN-TEMA.\r\n\r\nDu har fått informasjon om at:\r\n- meldinga er send til NAV-kontoret\r\n- du vert kontakta innan utgongen av DAG+DATO',
            en_US:
                '[bruker.navn] asks to speak to his/her contact person. The enquiry is regarding INSERT-TOPIC.\r\n\r\nYou have been informed that\r\n- the NAV office has been notified\r\n- you will be contacted within the end of DAY+DATE'
        }
    },
    ...
    'beee5507-bd09-401e-9b15-edade7c225f6': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] har fått informasjon om at innsending av nye saksopplysningar kan gjerast via www.nav.no/beskjedtilnav',
            en_US:
                '[bruker.navn] has been informed that information can be sent through the online service www.nav.no/beskjedtilnav'
        }
    },
    ...
    'cc7e88f3-3fe1-447c-a015-46a73963a354': {
        ...
        innhold: {
            ...
            en_US:
                '[bruker.navn] has an enquiry about TEXT\r\n\r\nYou have been informed that\r\n- explanation\r\n\r\nYou can find more information at nav.no\r\n\r\n- link to page at nav.no'
        }
    },
    ...
    'adbdb62c-5a8d-45b9-8af5-40e7d5e17ba1': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] er ringt opp att av rettleiaren sin, men fekk ikkje tatt telefonen.\r\n\r\nDu har fått informasjon om at\r\n- rettleiaren ikkje er tilgjengeleg for samtale akkurat no\r\n- du vert kontakta innan utgongen av DAG+DATO',
            en_US:
                '[bruker.navn] has been contacted by NAV, but was not able to answer the telephone.\r\n\r\nYou have been informed that\r\n- your contact person is not available at the moment\r\n- you will be contacted within the end of DAY+DATE\r\n'
        }
    },
    ...
    '056bfb59-e0a7-4131-93f8-866fb1913b88': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] ønskjer forlenga frist for å sende inn dokumentasjon til søknaden om YTING.\r\n\r\nDu har fått forlenga fristen for å sende inn dokumentasjon med 14 dagar, det vil seie innan utgongen av DAG+DATO',
            en_US:
                '[bruker.navn] refers to his/her application for BENEFIT and has requested an extension of the deadline to send in documentation.\r\n\r\nYour deadline for sending in documentation has been extended by 14 days, until DAG+DATO\r\n'
        }
    },
    'e262eca5-13d8-4665-a23c-5202edf74258': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] spør om arbeidsgjevaren har levert inntektsopplysningar.\r\n\r\nDu har fått beskjed om at vi har fått inntektsopplysningane.',
            en_US:
                '[bruker.navn] asks if his/her employer has sent in the income information form.\r\n\r\nYou have been informed that we have received the income information.'
        }
    },
    'a68b8c5f-934a-43cf-bfa5-d2e178c646fa': {
        ...
        innhold: {
            ...
            en_US:
                '[bruker.navn] has been asked to attend a meeting with his/her contact person DATE AND TIME, but is unable to come because REASON, and has requested a new appointment.\r\n\r\nYou have been informed that\r\n- the NAV office will consider whether the reason for your absence is valid\r\n- NAV will contact you if a new meeting is required\r\n'
        }
    },
    ...
    '67857773-4a56-40b9-a955-d8b1b77955c4': {
        ...
        innhold: {
            ...
            nn_NO:
                'Du har også fått informasjon om at du kan følgje med på:\r\n- www.nav.no/saksbehandlingstider\r\n- www.nav.no/dineutbetalinger',
            en_US:
                'You have also been informed that you can check the information at:\r\n\r\n- www.nav.no/saksbehandlingstider (text in Norwegian)\r\n- www.nav.no/paymentdates'
        }
    },
    ...
    '56771b6f-b172-421f-ae4a-bc0d4041e372': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] har spørsmål om skattetrekk på uføretrygd.\r\n\r\nDu har fått informasjon om:\r\n- fordi skattekortet ditt ikkje har eit tabelltrekk for trekkoden «Uføretrygd utbetalt fra NAV», har vi trekt etter prosentdelen av tabellkortet ditt.\r\n- vi har gitt beskjed til økonomiavdelinga om at du ønskjer trekk etter tabell, og at du ønskjer å få betalt tilbake for mykje trekt skatt.',
            en_US:
                '[bruker.navn] has an enquiry regarding the tax reduction for disability benefits payment.\r\n\r\nYou have been informed that:\r\n- since your tax card does not have a table-based deduction on the deduction code “Uføretrygd utbetalt fra NAV”, we have deducted according to the percentage on your tax card\r\n- we have forwarded a message to the financial unit (NAV Økonomi Pensjon) that you want to be deducted tax using table-based deduction'
        }
    },
    ...
    '7381b8f7-379c-4c73-987a-622726a8e0c2': {
        ...
        innhold: {
            ...
            nn_NO:
                '[bruker.navn] mottek YTING og har spørsmål om korleis meldekortet skal fyllast ut.\r\n\r\nEg har vist [bruker.fornavn]  informasjon på www.nav.no/meldekort\r\n',
            en_US:
                '[bruker.navn] receives BENEFIT and has an enquiry about how to fill out the employment status form.\r\n\r\nI have referred to information that [bruker.fornavn] can find on www.nav.no/employmentstatusform'
        }
    },
