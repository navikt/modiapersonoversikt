import { Behandlingsstatus, SakstemaBehandlingskjede, SakstemaSoknadsstatus } from '../../models/saksoversikt/sakstema';
...
export function getAremarkSakstemaListe(): SakstemaBehandlingskjede[] {
    return [
        {
            harTilgang: false,
            temakode: 'SYK',
