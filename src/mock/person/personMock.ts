...
function getTilfeldigPerson(fødselsnummer: string): Person {
    ...
    return {
        ...
        folkeregistrertAdresse: getTilfeldigAdresse(false),
        alternativAdresse: vektetSjanse(faker, 0.2) ? getTilfeldigAdresse(true) : undefined,
        postadresse: vektetSjanse(faker, 0.2) ? getTilfeldigAdresse(true) : undefined,
