...
import { lagDatoErInnenEtÅrRegel } from '../../../../utils/forms/commonValidatorRegler';
...
const regler: Valideringsregel<Utlandsadresse>[] = [
    gyldigTilRegel,
    {
        ...
        validator: (utenlandsadresse: Utlandsadresse) => !erTomStreng(utenlandsadresse.adresselinjer[0])
    },
    {
        felt: 'landkode',
