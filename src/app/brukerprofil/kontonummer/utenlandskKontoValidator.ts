...
const regler: Valideringsregel<EndreBankkontoState>[] = [
    ...
    },
    {
        ...
        validator: (konto: EndreBankkontoState) => BANK_UTLAND_KONTONUMMER_REGEX.test(konto.utenlandskKontonummer)
    },
    {
        felt: 'banknavn',
        feilmelding: 'Banknavn må være 36 eller færre tegn',
        validator: (konto: EndreBankkontoState) => BANK_UTLAND_NAVN_REGEX.test(konto.banknavn || '')
    },
    {
        felt: 'bankkode',
        feilmelding: 'Bankkode må være 36 eller færre tegn',
        validator: (konto: EndreBankkontoState) => BANK_UTLAND_KODE_REGEX.test(konto.bankkode)
    },
    {
        felt: 'swift',
        feilmelding: 'Swift må være 11 eller færre tegn',
        validator: (konto: EndreBankkontoState) => SWIFT_REGEX.test(konto.swift)
    },
    {
        felt: 'adresse',
